...
public class BlockDestroy : MonoBehaviour
{
    ...
    IEnumerator OnTriggerEnter(Collider col)//Færir kubban upp og siðan Eyðileggur brick þegar maður hoppar/snertir hann.
    {
        if (col.gameObject.tag == "Player")//ef player collider við serstakan hlut.
        {
